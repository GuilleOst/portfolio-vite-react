  ...
  return (
    <ul className="icon1">
      <li className="icon-content">
        <a href="https://www.linkedin.com/in/guillermo-ostermann/" target='_blank' rel="noreferrer" aria-label="LinkedIn" data-social="linkedin">
      ...
      <li className="icon-content">
        <a href="https://github.com/GuilleOst/TrabajosUTN" target='_blank' rel="noreferrer" aria-label="GitHub" data-social="github">
          <div className="filled" />
      ...
      <li className="icon-content">
        <a href="https://mail.google.com/mail/?view=cm&fs=1&to=guilleostermann@gmail.com" target='_blank' rel="noreferrer" aria-label="Gmail" data-social="gmail">
          <div className="filled" />
